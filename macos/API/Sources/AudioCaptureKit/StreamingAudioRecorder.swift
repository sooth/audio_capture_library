...
public class StreamingAudioRecorder: NSObject {
    ...
    public func addStreamDelegate(_ delegate: AudioStreamDelegate) {
        delegateQueue.async { [weak self] in
            self?.streamDelegates.append(delegate)
        }
    }
    
    public func removeStreamDelegate(_ delegate: AudioStreamDelegate) {
        delegateQueue.async { [weak self] in
